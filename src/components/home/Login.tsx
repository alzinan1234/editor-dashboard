...
import { loginEditor } from "../apiClient";
...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // loginEditor takes (email, password) as separate args — not an object
      const res = await loginEditor(email, password);
          ...
          <div className="flex items-center justify-between mb-8 w-full">
            <div className="flex items-center space-x-2">
              <input
                ...
                className="form-checkbox h-4 w-4 text-[#3448D6] border-gray-300 rounded focus:ring-[#3448D6] cursor-pointer text-black"
              />
              <label
                htmlFor="rememberMe"
